					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<!-- /.card-header -->
								<!-- form start -->
								<form:form role="form" action="author-save"
										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<label style="color: red; font-weight: normal;">${userMessage}</label>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label>Roles</label>
													<div class="input-group">
														<form:select path="authorities" itemLabel="authority"
															itemValue="authority" items="${roles}"
															class="form-control" />
													</div>
