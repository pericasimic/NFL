								...
								<form:form role="form" action="blog-save" modelAttribute="blog"
									...
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												<form:hidden path="id" />
												<form:hidden path="titleURL" />
												<form:hidden path="numberViews" />
												...
												<div class="form-group">
													...
													<div class="input-group">
														<form:input path="subheading" type="text"
													...
													<form:errors class="text-danger" path="subheading" />
												</div>
												<div class="form-group">
													<label>Text body</label>
													<div class="input-group">
														<form:textarea path="text" type="text"
															class="form-control" placeholder="Enter text body" />
														<div class="input-group-append">
															<span class="input-group-text"> <i
																class="fas fa-align-justify"></i>
															</span>
												...
												<div class="form-group">
													...
													<div class="input-group">
														<form:select path="category.id" itemLabel="name"
															itemValue="id" items="${categoryList}"
															class="form-control" />
													</div>
												</div>
												<div class="form-group">
													<label>Author</label>
													<div class="input-group">
														<form:select path="author.id" itemLabel="name"
															itemValue="id" items="${authorList}" class="form-control" />
													</div>
												</div>
												<div class="form-group">
													<label>Teams</label>
													<div class="input-group">
														<form:select path="teams" itemLabel="name" itemValue="id"
															items="${teamList}" class="form-control" />
													</div>
												</div>
												<div class="form-group">
													<label>Choose Photos</label> <input type="file"
													...
													<div class="form-group">
														...
														<div class="timeline-body">
															<c:forEach var="i" begin="0" end="${imageList.size()-1}">
																<label> <form:radiobutton path="image.id"
																		value="${imageList[i].id}" /> <img
																	src="${pageContext.request.contextPath}/${imageList[i].image}"
