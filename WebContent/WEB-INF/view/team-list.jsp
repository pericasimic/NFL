							...
							<div class="card">
								<div class="card-header">
									<div class="card-tools">
										<a href="team-form" class="btn btn-success"> <i
											class="fas fa-plus-square"></i> Add new Team
										</a>
									</div>
								</div>
								<!-- /.card-header -->
							...
							<div class="card">
								...
								<div class="card-body">
									<table class="table table-bordered">
										...
										<tbody>
											<c:forEach var="team" items="${teamList}" varStatus="loop">
												<tr>
													<td>${loop.index + 1}</td>
													<td class="text-center" class="">${team.name}</td>
													<td class="text-center"><img
														src="${pageContext.request.contextPath}/${team.image}"
														style="max-width: 80px; max-height: 80px"></td>
													<td class="text-center">${team.division.title}</td>
													<td class="text-center">
														<div class="btn-group">
															<a href="team-form-update?id=${team.id}"
																class="btn btn-info"> <i class="fas fa-edit"></i>
															</a>
															<button type="button" class="btn btn-info"
																data-toggle="modal"
																data-target="#delete-modal-${team.id}">
