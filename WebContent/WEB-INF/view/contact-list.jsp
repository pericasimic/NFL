									...
									<table class="table table-bordered">
										...
										<tbody id="sort-list">
											<c:forEach var="contact" items="${contactList}"
												...
												<tr>
													<td>${loop.index + 1}</td>
													<c:if test="${contact.seen == true}">
														<td class="text-center"><span class="text-success">seen</span>
														</td>
													</c:if>
													<c:if test="${contact.seen == false}">
														<td class="text-center"><span class="text-danger">not
																seen</span></td>
													</c:if>
													...
													<td class="text-center">
														<div class="btn-group">
															<a href="contact-details?id=${contact.id}"
																class="btn btn-info"> <i class="fas fa-info-circle"></i>
															</a>
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer justify-content-between">
																...
																<a href="category-delete?id=${contact.id}"
