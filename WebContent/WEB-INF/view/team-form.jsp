					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<!-- /.card-header -->
								<!-- form start -->
								<form:form role="form" action="team-save" modelAttribute="team"
										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="input-group">
														<form:select path="division.id" itemLabel="title"
															itemValue="id" items="${divisionList}"
															class="form-control" />
													</div>
												</div>

												<div class="form-group">
													<label>Choose Photos</label> <input type="file" name="file"
														class="form-control">
												</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<label>Photo</label>
															<div class="input-group">
																<c:if test="${empty team.image}">
																	<img src="http://placehold.it/500x400" alt=""
																		class="img-fluid">
																</c:if>
																<c:if test="${not empty team.image}">
																	<img
																		src="${pageContext.request.contextPath}/${team.image}"
																		alt="" class="img-fluid">
																</c:if>
															</div>
														</div>
									...
									<div class="card-footer">
										...
										<a href="team-list" class="btn btn-outline-secondary">Cancel</a>
									</div>
								</form:form>
							</div>
							<!-- /.card -->
