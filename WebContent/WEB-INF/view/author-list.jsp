							...
							<div class="card">
								...
								<div class="card-body">
									<div class="col-lg-6" style="padding: 10px">
										<form:form method="post" action="search-author"
											modelAttribute="authorSearch">
									...
									<table class="table table-bordered">
										...
										<tbody>
											<c:forEach var="author" items="${authorList}"
												...
												<tr>
													<td>${loop.index + 1}</td>
													<c:if test="${author.enabled == true}">
														<td class="text-center"><span class="text-success">enabled</span>
														</td>
													</c:if>
													<c:if test="${author.enabled == false}">
													...
													<td class="text-center">
														<div class="btn-group">
															<a href="author-edit-roles?id=${author.id}"
																class="btn btn-info"> <i class="fas fa-edit"></i>
															</a> <a href="author-enable?id=${author.id}"
																class="btn btn-info"> <c:if test="${author.enabled}">
