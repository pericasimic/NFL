						...
						<div class="col-md-12">
							<div class="card card-primary">
								<div class="card-header">
									<h3 class="card-title">Division Form</h3>
								</div>
								<!-- /.card-header -->
								<!-- form start -->
								<form:form role="form" action="division-save"
									modelAttribute="division" enctype="multipart/form-data">
									<div class="card-body">
										<div class="row">
											<div class="col-md-6">
												<form:hidden path="id" />
												...
												<div class="form-group">
													...
													<div class="input-group">
														<form:input path="titleButton" type="text"
															class="form-control" placeholder="Enter title button" />
														<div class="input-group-append">
															<span class="input-group-text"> <i
																class="fas fa-ad"></i>
															</span>
													...
													<form:errors class="text-danger" path="titleButton" />
												</div>
												<div class="form-group">
													<label>URL button</label>
													<div class="input-group">
														<form:input path="urlButton" type="text"
															class="form-control" placeholder="Enter URL button" />
														<div class="input-group-append">
															<span class="input-group-text"> <i
																class="fas fa-ad"></i>
															</span>
													...
													<form:errors class="text-danger" path="urlButton" />
												</div>
												<div class="form-group">
													<label>Number Order</label>
													<div class="input-group">
														<form:input path="numOrder" type="text"
												...
												<c:if test="${not empty division.teams}">
													<div class="form-group">
														<label>Teams</label>
														<div class="input-group">
												...
												<div class="form-group">
													<label>Add new image</label> <input type="file" name="file"
														class="form-control">
												</div>
												<label style="color: red; font-weight: normal;">${message}</label>
											</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															<label>Photo</label>
															<div class="input-group">
																<c:if test="${empty division.image}">
																	<img src="http://placehold.it/500x400" alt=""
																		class="img-fluid">
																</c:if>
																<c:if test="${not empty division.image}">
																	<img
									...
									<div class="card-footer">
										...
										<a href="division-list" class="btn btn-outline-secondary">Cancel</a>
									</div>
								</form:form>
							</div>
							<!-- /.card -->
