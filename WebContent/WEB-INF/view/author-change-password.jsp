						...
						<div class="col-md-12">
							<div class="card card-primary">
								...
								<form:form role="form" action="author-change-password-action"
									modelAttribute="changePassword" enctype="multipart/form-data">
										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<form:input id="oldPwd" path="oldPassword" type="password"
														class="form-control" placeholder="Enter old password" />
												</div>
												<div class="form-group">
													<label>New password</label>

													<form:input id="newPwd" path="newPassword" type="password"
														class="form-control" placeholder="Enter new password" />
												</div>
												<div class="form-group">
													<label>Confirm new password</label>
													<form:input id="conPwd" path="confirmPassword"
									...
									<div class="card-footer">
										<button type="submit" onclick="return verifyPassword()"
