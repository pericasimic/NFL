			...
			<div class="container">
				...
				<div id="navbarcollapse" class="collapse navbar-collapse">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a href="blog-page" class="nav-link">Blog</a></li>
	...
	<div class="container">
		<div class="row">
			...
			<main class="posts-listing col-lg-8">
				<div class="container">
					<h2 class="mb-3">Search results for "${search.term}"</h2>
					<div class="row">
						<!-- post -->
						<c:forEach var="blog" items="${blogItems}">
						...
						<ul
							...
							<c:if test="${count == 1}">
								<li class="page-item"><a
									href="blog-search-page?id=${activeNumber}&word=${search.term}"
									class="page-link"> <i class="fa fa-angle-left"></i>
								</a></li>
							</c:if>
							<c:if test="${count > 1}">
								<li class="page-item"><a
									href="blog-search-page?id=${count-1}&word=${search.term}"
							...
							<c:forEach begin="1" end="${pageNumber}" varStatus="loop">
								<c:if test="${activeNumber == loop.index}">
									<li class="page-item"><a
										href="blog-search-page?id=${loop.index}&word=${search.term}"
