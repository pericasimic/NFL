			...
			<main class="posts-listing col-lg-8">
				<div class="container">
					<h2 class="mb-3 author d-flex align-items-center flex-wrap">
						...
						<div class="title">
							<span>&nbspPosts by author
								"${author.name}&nbsp${author.lastname}"</span>
						</div>
					</h2>
					<div class="row">
						...
						<ul
							...
							<c:if test="${count == 1}">
								<li class="page-item"><a
									href="../author/author-page?id=${activeNumber}&idAuthor=${author.id}"
									class="page-link"> <i class="fa fa-angle-left"></i>
								</a></li>
							</c:if>
							<c:if test="${count > 1}">
								<li class="page-item"><a
									href="../author/author-page?id=${count-1}&idAuthor=${author.id}"
							...
							<c:forEach begin="1" end="${pageNumber}" varStatus="loop">
								<c:if test="${activeNumber == loop.index}">
									<li class="page-item"><a
										href="../author/author-page?id=${loop.index}&idAuthor=${author.id}"
