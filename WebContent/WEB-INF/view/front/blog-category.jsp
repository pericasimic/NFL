						...
						<ul
							...
							<c:if test="${count == 1}">
								<li class="page-item"><a
									href="../category/category-page?id=${activeNumber}&idCategory=${category.id}"
									class="page-link"> <i class="fa fa-angle-left"></i>
								</a></li>
							</c:if>
							<c:if test="${count > 1}">
								<li class="page-item"><a
									href="../category/category-page?id=${count-1}&idCategory=${category.id}"
							...
							<c:forEach begin="1" end="${pageNumber}" varStatus="loop">
								<c:if test="${activeNumber == loop.index}">
									<li class="page-item"><a
										href="../category/category-page?id=${loop.index}&idCategory=${category.id}"
