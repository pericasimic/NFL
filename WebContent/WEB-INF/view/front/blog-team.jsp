	...
	<div class="container">
		<div class="row">
			...
			<main class="posts-listing col-lg-8">
				<div class="container">
					<h2 class="mb-3">Team "${team.name}"</h2>
					<div class="row">
						<!-- post -->
						<c:forEach var="blog" items="${blogs}">
							<div class="post col-xl-6">
								<div class="post-thumbnail">
									<a href="../post/${blog.titleURL}"><img src="../${blog.image}"
						...
						<ul
							...
							<c:if test="${count == 1}">
								<li class="page-item"><a
									href="blog-page-item?id=${activeNumber}&idTeam=${team.id}" class="page-link">
										<i class="fa fa-angle-left"></i>
								</a></li>
							</c:if>
							<c:if test="${count > 1}">
								<li class="page-item"><a
									href="blog-page-item?id=${count-1}&idTeam=${team.id}" class="page-link"> <i
										class="fa fa-angle-left"></i></a></li>
							</c:if>
							<c:forEach begin="1" end="${pageNumber}" varStatus="loop">
								<c:if test="${activeNumber == loop.index}">
									<li class="page-item"><a
										href="blog-page-item?id=${loop.index}&idTeam=${team.id}"
										class="page-link active">${loop.index}</a></li>
								</c:if>
								<c:if test="${activeNumber != loop.index}">
									<li class="page-item"><a
										href="blog-page-item?id=${loop.index}&idTeam=${team.id}" class="page-link">${loop.index}</a></li>
								</c:if>
							</c:forEach>
